...
def extract_text(image, bbox):
    ...
    _, encoded_image = cv2.imencode('.png', roi)
    ...
    if texts:
        ...
        filtered_text = ''.join([char for char in raw_text if char.isalnum()])  # Elimina caracteres no alfanuméricos
        limited_text = filtered_text[:6]  # Limita el resultado a los primeros 7 caracteres
    else:
        limited_text = ''
